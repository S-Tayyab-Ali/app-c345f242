      ...
      <div className="max-w-4xl mx-auto space-y-12">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="p-6 text-center space-y-4 bg-slate-900 border-slate-800">
            <div className="w-12 h-12 bg-teal-900/30 rounded-full flex items-center justify-center mx-auto text-teal-400 border border-teal-800">
              <Shield size={24} />
            </div>
          ...
          <Card className="p-6 text-center space-y-4 bg-slate-900 border-slate-800">
            <div className="w-12 h-12 bg-orange-900/30 rounded-full flex items-center justify-center mx-auto text-orange-400 border border-orange-800">
              <Users size={24} />
            </div>
            <h3 className="font-bold text-lg text-slate-100">
          ...
          <Card className="p-6 text-center space-y-4 bg-slate-900 border-slate-800">
            <div className="w-12 h-12 bg-purple-900/30 rounded-full flex items-center justify-center mx-auto text-purple-400 border border-purple-800">
              <HelpCircle size={24} />
            </div>
            <h3 className="font-bold text-lg text-slate-100">
          ...
          <div className="space-y-6">
            {faqs.map((faq, index) => (
              <div key={index} className="border-b border-slate-800 pb-6 last:border-0 last:pb-0">
                <h3 className="font-bold text-lg text-slate-200 mb-2">
        ...
        <div className="text-center space-y-4">
          ...
          <a 
            ...
            className="inline-flex items-center gap-2 text-teal-400 font-medium hover:text-teal-300"
          >
            <Mail size={20} />
